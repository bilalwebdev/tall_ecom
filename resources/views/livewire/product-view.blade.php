        ...
        <div class="flex flex-col-reverse" wire:ignore>
            <div class="w-full aspect-w-1 aspect-h-1">
                <div class="ta-gallery ta-gallery-aspect-hd" x-data="taGallery" data-item="ta-gallery-element" data-size="ta-gallery-size" data-active="ta-gallery-element-active" data-lazy="ta-gallery-image-lazy" data-min-height="10rem" data-start="0" data-duration="0.3s" data-origin="center center" data-timing="ease-in-out" data-autoplay="true" data-interval="5000" data-pauseonhover="true">
                    ...
                    @endforelse
                    <!--- START BUTTONS /-->
                    <button type="button" class="flex items-center justify-center w-10 h-10 text-white bg-black bg-opacity-75 border-2 border-white rounded-full shadow-xl ta-gallery-button -left-5 sm:left-2 focus:ring focus:ring-rose-500" x-on:click="previous()" x-show="loaded">
                        <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
                            <path d="M31.7 239l136-136c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9L127.9 256l96.4 96.4c9.4 9.4 9.4 24.6 0 33.9L201.7 409c-9.4 9.4-24.6 9.4-33.9 0l-136-136c-9.5-9.4-9.5-24.6-.1-34z"></path>
                        </svg>
                    </button>
                    <button type="button" class="flex items-center justify-center w-10 h-10 text-white bg-black bg-opacity-75 border-2 border-white rounded-full shadow-xl ta-gallery-button -right-5 sm:right-2 focus:ring focus:ring-rose-500" x-on:click="next()" x-show="loaded">
                        <svg class="w-6 h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
        ...
        <div class="px-4 mt-10 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            <div class="mt-3">
                ...
                <div class="flex flex-col mt-3 mb-4 md:flex-row">
                    <a href="#{{$product->category->slug}}" class="text-base font-medium text-rose-600 md:mr-4 hover:text-rose-500 dark:text-rose-200 dark:hover:text-rose-300">{$pro{duct->category->name}}</a>
                    ...
                    <x-review-star :review="3.9">
                        ...
                        <x-slot name="suffix">
                            ...
                            <div class="flex ml-4">
                                <a href="#" class="text-sm font-medium text-rose-600 hover:text-rose-500 dark:text-rose-200 dark:hover:text-rose-300">{{trans_choice('product.see_all_review', 512, ['count'=>512])}}</a>
                            </div>
                        </x-slot>
                    </x-review-star>
            ...
            <div class="mt-6">
                ...
                <fieldset x-data="{color:@entangle('color').defer}" class="mt-2">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <label class="-m-0.5 relative rounded-full flex items-center justify-center cursor-pointer focus:outline-none ring-rose-600" :class="{ 'ring-2 ring-offset-2': color==='{{$color['value']}}', 'cursor-not-allowed':color==='disabled' }">
            ...
            <div class="mt-6">
                <div class="flex items-center">
                    ...
                    <a href="#" class="ml-2 text-sm font-medium text-rose-600 dark:text-rose-200 hover:dark:text-rose-300 hover:text-rose-500">({{__('product.sizing_info')}})</a>
                </div>
                ...
                <fieldset x-data="{size:@entangle('size').defer}" class="mt-2">
                    ...
                    <div class="grid grid-cols-3 gap-3 sm:grid-cols-6">
                        ...
                        <label class="flex items-center justify-center px-2 py-3 text-sm font-medium uppercase border rounded-md shadow-sm cursor-pointer sm:flex-1 focus:outline-none" :class="{ 'cursor-not-allowed': size ==='disabled', 'ring-2 ring-offset-2 ring-rose-500': size === '{{$size['value']}}', 'bg-rose-600 border-transparent text-white hover:bg-rose-700': (size === '{{$size['value']}}'), 'bg-white border-gray-200 text-gray-900 hover:bg-gray-50': !(size === '{{$size['value']}}') }">
        ...
        <div class="flex flex-col items-center justify-center" wire:ignore>
            <div class="w-full aspect-w-1 aspect-h-1">
                <div class="ta-gallery ta-gallery-aspect-hd" x-data="taGallery" data-item="ta-gallery-element"
                    ...
                    data-min-height="10rem" data-start="0" data-duration="0.3s" data-origin="center center"
                    data-timing="ease-in-out" data-autoplay="true" data-interval="5000" data-pauseonhover="true">
                    <!--- START SLIDES /-->
                    @forelse($product->media as $key => $media)
                        <div class="rounded-lg ta-gallery-element ta-gallery-anim-slide" x-cloak>
                            <figure>
                                <img src="{{ $media->getUrl() }}" alt="{{ $media->name }}" class="ta-gallery-image"
                    ...
                    @empty
                        <div class="rounded-lg ta-gallery-element ta-gallery-anim-slide" x-cloak>
                            <figure>
                                <img src="{{ placeholder_image() }}" alt="{{ $product->title }}"
                                    class="ta-gallery-image" loading="lazy" x-ref="height" />
                                <figcaption
                                    class="px-4 py-1 text-sm font-semibold text-white bg-gray-900 bg-opacity-25 ta-gallery-image-caption bg-blur-2">
                                    Product Image
                                </figcaption>
                    ...
                    <!--- START BUTTONS /-->
                    <button type="button"
                        class="flex items-center justify-center w-10 h-10 text-white bg-black bg-opacity-75 border-2 border-white rounded-full shadow-xl ta-gallery-button -left-5 sm:left-2 focus:ring focus:ring-rose-500"
                    ...
                    <button type="button"
                        class="flex items-center justify-center w-10 h-10 text-white bg-black bg-opacity-75 border-2 border-white rounded-full shadow-xl ta-gallery-button -right-5 sm:right-2 focus:ring focus:ring-rose-500"
                ...
                <div class="flex gap-1 text-sm text-yellow-400">
                    <x-review-star :review="3.9">
                        ...
                        <x-slot name="suffix">
                            ...
                            <div class="flex ml-4">
                                <a href="#"
                                    class="text-sm font-medium text-rose-600 hover:text-rose-500 dark:text-rose-200 dark:hover:text-rose-300">{{ trans_choice('product.see_all_review', 512, ['count' => 512]) }}</a>
                            </div>
                        </x-slot>
                    </x-review-star>
                </div>
                            ...
                            <label
                                ...
                                :class="{
                                    'cursor-not-allowed': size ===
                                        'disabled',
                                    'ring-2 ring-offset-2 ring-rose-500': size ===
                                        '{{ $option->size->name }}',
        ...
        <div
            ...
            <div class="lg:col-span-4">
                <h2 id="reviews-heading" class="text-2xl font-bold tracking-tight text-gray-900">
                    {{ __('product.customer_reviews') }}</h2>
                ...
                <div class="flex items-center mt-3">
                    <div>
                        <div class="flex items-center">
                            ...
                            <svg class="flex-shrink-0 w-5 h-5 text-yellow-400" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
                                    d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401z"
                                    clip-rule="evenodd"></path>
                    ...
                    <p class="ml-2 text-sm text-gray-900">
                        {{ __('product.based_on_reviews', ['count' => rand(120, 540)]) }}
                    </p>
                </div>
                        ...
                        <div class="py-12">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=8&amp;w=256&amp;h=256&amp;q=80"
                                    alt="Emily Selman." class="w-12 h-12 rounded-full">
                                <div class="ml-4">
                                    <h4 class="text-sm font-bold text-gray-900">Emily Selman</h4>
                                    <div class="flex items-center mt-1">
                        ...
                        <div class="py-12">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=8&amp;w=256&amp;h=256&amp;q=80"
                                    alt="Hector Gibbons." class="w-12 h-12 rounded-full">
                                <div class="ml-4">
                                    <h4 class="text-sm font-bold text-gray-900">Hector Gibbons</h4>
                                    <div class="flex items-center mt-1">

                                        <svg class="flex-shrink-0 w-5 h-5 text-yellow-400" x-state:on="Active"
                                            x-state:off="Default"
                        ...
                        <div class="py-12">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&amp;ixqx=oilqXxSqey&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=256&amp;h=256&amp;q=80"
                                    alt="Mark Edwards." class="w-12 h-12 rounded-full">
                                <div class="ml-4">
                                    <h4 class="text-sm font-bold text-gray-900">Mark Edwards</h4>
                                    <div class="flex items-center mt-1">
...
<div
    class="ta-gallery-element-active ta-gallery-anim-slide ta-gallery-anim-right-in ta-gallery-anim-right-out ta-gallery-anim-left-in ta-gallery-anim-left-out">
</div>
@push('styles')
